...
public class WorldGenIngotterMinable extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, BlockPos pos) {
        ...
        if (blockState.getBlock().isReplaceableOreGen(blockState, world, pos, blockToReplace) && veinSize <= 4) {
    ...
    public boolean generateSmallVein(World world, Random random, int x, int y, int z) {
        boolean r = oreToGenerate != null && world.setBlockState(new BlockPos(x, y, z), oreToGenerate, 2);
        ...
        for (int i = 1; i < veinSize; i++) {
            ...
            r |= oreToGenerate != null && world.setBlockState(new BlockPos(posX, posY, posZ), oreToGenerate, 2);
        }
        return r;
    }
}
