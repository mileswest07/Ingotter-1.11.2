...
public class DefinedBlockDimOreGen implements IWorldGenerator {
    ...
    private void generateCustom(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        for (String ore : ConfigOreHandler.oreArray) {
            ...
            if (!oreName.isEmpty() && ConfigOreHandler.oreBoolean && blockOre != null && oreName.contains("-replace:") && oreName.contains("-dimension:") && !oreName.contains("-biome:")) {
                ...
                if(dimCustom != null && blockToReplaceCustom != null){
                    generateOre(blockStateOre, world, random, chunkX, chunkZ, minY, maxY, minVein, maxVein, perChunk, Integer.parseInt(dimCustom), blockToReplaceCustom);
                }}
        }
    }
    ...
    private void generateIngotter(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        for (String ore : ConfigOreHandler.oreIngotterArray) {
            ...
            if (!oreName.isEmpty() && ConfigOreHandler.oreIngotterBoolean && blockOre != null && oreName.contains("-replace:") && oreName.contains("-dimension:") && !oreName.contains("-biome:")) {
                ...
                if(dimIngotter != null && blockToReplaceIngotter != null){
                    generateOre(blockStateOre, world, random, chunkX, chunkZ, minY, maxY, minVein, maxVein, perChunk, Integer.parseInt(dimIngotter), blockToReplaceIngotter);
                }}
        }
    }

    private void generateOre(IBlockState ore, World world, Random random, int chunkX, int chunkZ, int minY, int maxY, int minVeinSize, int maxVeinSize, int chancesToSpawn, int dimension, Block blockToReplace) {
