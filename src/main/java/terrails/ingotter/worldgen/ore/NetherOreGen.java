...
public class NetherOreGen implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        //Modded
        generateOre(ConfigNetherHandler.copper, ModOres.oreCopper, world, random, chunkX, chunkZ, ConfigNetherHandler.copperMinY, ConfigNetherHandler.copperMaxY, ConfigNetherHandler.copperMinVeinSize, ConfigNetherHandler.copperMaxVeinSize, ConfigNetherHandler.copperVeinChance);
        generateOre(ConfigNetherHandler.tin, ModOres.oreTin, world, random, chunkX, chunkZ, ConfigNetherHandler.tinMinY, ConfigNetherHandler.tinMaxY, ConfigNetherHandler.tinMinVeinSize, ConfigNetherHandler.tinMaxVeinSize, ConfigNetherHandler.tinVeinChance);
        generateOre(ConfigNetherHandler.silver, ModOres.oreSilver, world, random, chunkX, chunkZ, ConfigNetherHandler.silverMinY, ConfigNetherHandler.silverMaxY, ConfigNetherHandler.silverMinVeinSize, ConfigNetherHandler.silverMaxVeinSize, ConfigNetherHandler.silverVeinChance);
        generateOre(ConfigNetherHandler.lead, ModOres.oreLead, world, random, chunkX, chunkZ, ConfigNetherHandler.leadMinY, ConfigNetherHandler.leadMaxY, ConfigNetherHandler.leadMinVeinSize, ConfigNetherHandler.leadMaxVeinSize, ConfigNetherHandler.leadVeinChance);
