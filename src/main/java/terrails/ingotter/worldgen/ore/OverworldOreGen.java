...
public class OverworldOreGen implements IWorldGenerator{
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        generateOre(ConfigOverworldHandler.emerald, Blocks.EMERALD_ORE, world, random, chunkX, chunkZ, ConfigOverworldHandler.emeraldMinY, ConfigOverworldHandler.emeraldMaxY, ConfigOverworldHandler.emeraldMinVeinSize, ConfigOverworldHandler.emeraldMaxVeinSize, ConfigOverworldHandler.emeraldVeinChance);
        ...
        generateOre(ConfigOverworldHandler.iron, ModOres.oreTin, world, random, chunkX, chunkZ, ConfigOverworldHandler.tinMinY, ConfigOverworldHandler.tinMaxY, ConfigOverworldHandler.tinMinVeinSize, ConfigOverworldHandler.tinMaxVeinSize, ConfigOverworldHandler.tinVeinChance);
